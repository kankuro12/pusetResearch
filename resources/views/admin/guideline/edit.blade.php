    ...
    <form action="{{route('admin.guideline.edit',['guideline_id'=>$guideline->id])}}" method="POST">
        ...
        <div class="row">
            <div class="col-md-3 mb-2">
                ...
                <input type="text" name="title" id="title" value="{{$guideline->title}}" class="form-control" required >
            </div>
            <div class="col-md-12 mb-2">
                <label for="description">Desription</label>
                <textarea type="text" name="description" id="description" class="form-control note" required >{{$guideline->description}}</textarea>
            </div>
